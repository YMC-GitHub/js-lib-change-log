...
(function (global, factory) {
  ...
  (global = global || self, global['change-log'] = factory());
  ...
  var writeToFs = function() {
    ...
    var preset = ref.preset; if ( preset === void 0 ) preset = 'yemiancheng';
    ...
    // 获取新的
    var newData = gitToChangelog({ preset: preset, releaseCount: 1 });
